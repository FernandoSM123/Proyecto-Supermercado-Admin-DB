...
BEGIN
    insertFactura(1, 1010, TO_DATE('2023-11-04', 'YYYY-MM-DD'), TO_TIMESTAMP('2023-11-04 12:30:00', 'YYYY-MM-DD HH24:MI:SS'), 137, 1);
    insertFactura(2, 7500, TO_DATE('2023-11-05', 'YYYY-MM-DD'), TO_TIMESTAMP('2023-11-05 14:45:00', 'YYYY-MM-DD HH24:MI:SS'), 137, 2);
    insertFactura(3, 12890, TO_DATE('2023-11-06', 'YYYY-MM-DD'), TO_TIMESTAMP('2023-11-06 15:15:00', 'YYYY-MM-DD HH24:MI:SS'), 137, 3);
    insertFactura(4, 50467, TO_DATE('2023-11-07', 'YYYY-MM-DD'), TO_TIMESTAMP('2023-11-07 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), 137, 4);
    insertFactura(5, 90456, TO_DATE('2023-11-08', 'YYYY-MM-DD'), TO_TIMESTAMP('2023-11-08 18:20:00', 'YYYY-MM-DD HH24:MI:SS'), 137, 5);
END;
/
