...
BEGIN
InsertProducto(1808124003091, 'Papel higiénico', 1500.00, 99, 'Abarrotes');
InsertProducto(4370783586295, 'Pasta de dientes colgate', 1000.00, 56, 'Cuidado personal');
InsertProducto(5105235176997, 'Jabón de baño', 500.00, 76, 'Cuidado personal');
InsertProducto(3934608083093, 'Champú', 2500.00, 93, 'Cuidado personal');
...
InsertProducto(6276827953045, 'Detergente líquido', 1500.00, 53, 'Mercancías');
...
InsertProducto(1234567890126, 'Cereal de chocolate', 3000.00, 65, 'Mercancías');
InsertProducto(1234567890127, 'Salsa de tomate', 1500.00, 55, 'Abarrotes');
InsertProducto(1234567890128, 'Pañuelos desechables', 1800.00, 70, 'Mercancías');
InsertProducto(1234567890129, 'Pasta dental para niños', 1200.00, 90, 'Cuidado personal');
InsertProducto(1234567890130, 'Botella de vino tinto', 5000.00, 30, 'Abarrotes');
InsertProducto(1234567890131, 'Papel toalla', 2500.00, 75, 'Mercancías');
InsertProducto(1234567890132, 'Café instantáneo', 3500.00, 45, 'Abarrotes');
END;
/
